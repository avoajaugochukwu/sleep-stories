...
- **Cinematic** — compose like a film still: a strong single subject, layered depth (separated foreground and background), faint atmospheric haze, and motivated, directional light that sculpts the subject out of the surrounding dark.
- **Optional neon accent** — the frame always stays deep and shadowy. ONLY when a real light source naturally fits the scene, add ONE small glowing neon accent in a SINGLE color, motivated by that source (e.g. fireflies, a neon sign, embers, a glowing dial, bioluminescence, distant city lights). Vary the hue across scenes (green, orange, amber, teal, pink, cyan, blue, violet) — one hue per scene, never blue/purple by default. Many scenes will have NO neon at all — that is fine; muted moonlight, warm lamplight, or cool shadow is just as good. Never force a colored light where none belongs, and do NOT scatter multiple colored lights around the frame.
